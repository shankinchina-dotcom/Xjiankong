...
> 状态：**V4 已上线（Task 8）。V4.1 本地 RC 已验证、待 NAS 部署。** 生产仍为 `v2-beta-v4-rc-20260715`（NAS Config ID `sha256:365c92d5…`）；本地 `v2-beta-v4-rc-20260716` / `01264222` 未切换。
>
...
- 实施 worktree：`TrendRadar-v2-beta-history`。已上线 `18c1fbad`；V4.1 代码 `01264222`（未部署）。生产 RC `v2-beta-v4-rc-20260715` / NAS `sha256:365c92d5…`。
- Task 7–8：已完成；回滚 `v2-beta-rc-20260713` / `sha256:c122cdb56076…`。
- V4.1（2026-07-16）：证据折叠 + 大厂色 + RSS 5 条预览；fixture 24/24；本地 RC `v2-beta-v4-rc-20260716` 已验证；**待老板批准后 NAS 单点切换**。见 [`../plans/2026-07-16-v4-1-ui-polish-handoff.md`](../plans/2026-07-16-v4-1-ui-polish-handoff.md)。
