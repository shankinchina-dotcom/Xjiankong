...
- 生产基线：`xjiankong-trendradar:v2-beta-v4-rc-20260716`（**V4.1 免费切换 2026-07-16 已完成**；V4 Task 8 付费全链路曾在 `v4-rc-20260715` 通过）。直接回滚：`v2-beta-v4-rc-20260715` / NAS `sha256:365c92d5…`（或更稳的 `v2-beta-rc-20260713` / NAS `sha256:c122cdb56076…`）。二级历史：`v2-alpha-20260709`。
- V4 / V4.1：编辑型层级已上线；V4.1（证据折叠、大厂色点状、RSS 5 条预览）代码 `01264222`，NAS 运行 Config ID `sha256:c0262e755c50…`，DiffID chain `1a54fd0b36a1…`。**未触发付费重跑**；新 HTML 的 V4.1 交互需下次 cron／单独批准的付费跑后才出现在公网页。入口：[交接摘要](superpowers/plans/2026-07-16-v4-1-ui-polish-handoff.md)、[V4 计划](superpowers/plans/2026-07-15-v4-editorial-report-production.md)。
...
| 4 | V4 编辑型报告生产化 | **V4.1 已上线（免费）** | 生产 `v4-rc-20260716` / NAS `c0262e75…`；付费验收可选、未自动执行 | 可选：一次付费看证据折叠／RSS 预览；并行稳定性观察 | Terra 高／Sol 高 |
