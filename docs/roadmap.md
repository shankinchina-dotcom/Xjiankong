...
- 生产基线：`xjiankong-trendradar:v2-beta-v4-rc-20260716`（**V4.1 免费切换 + 一次付费全链路 2026-07-16 均通过**）。NAS Config ID `sha256:c0262e755c50…`；代码 `01264222`。直接回滚：`v2-beta-v4-rc-20260715` / `365c92d5…` 或 `v2-beta-rc-20260713` / `c122cdb56076…`。
- V4.1 公网验证页：`/html/2026-07-16/00-25.html`（`evidence-toggle` / `feed-toggle` / `ev-brand-*` / suite 均在；默认证据折叠）。证据：`backups/v4-1-task8-20260716-002145`。入口：[交接摘要](superpowers/plans/2026-07-16-v4-1-ui-polish-handoff.md)、[V4 计划](superpowers/plans/2026-07-15-v4-editorial-report-production.md)。
...
| 4 | V4 编辑型报告生产化 | **V4.1 已上线（免费+付费）** | 生产 `v4-rc-20260716`；付费页 `00-25.html` DOM 通过 | 阶段完成；进入稳定性观察；清理须另批 | Terra 高／Sol 高 |
...
阶段 4（V4／V4.1）已完成。阶段 3 稳定性观察继续；生产镜像变更须老板另批。阶段 5 的离线样本准备可并行；阶段 6 只允许研究与设计，不允许接入、部署或修改生产配置。
...
- [V4.1 交接摘要（生产真相压缩）](superpowers/plans/2026-07-16-v4-1-ui-polish-handoff.md)
- [V4 编辑型报告设计](superpowers/specs/2026-07-15-v4-editorial-report-ui-design.md)
- [V4 生产实施计划（含 Task 1–9）](superpowers/plans/2026-07-15-v4-editorial-report-production.md)
- [V4 权威视觉原型](superpowers/prototypes/2026-07-15-xjiankong-report-v4-editorial.html)
- [稳定性观察日志](stability-observation.md)
- [NAS 部署实战手册](nas-deployment.md)
